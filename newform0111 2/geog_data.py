#!/usr/bin/env python
"""Procuring datasets for newform0111
...
def procure_dataset(dataset_name, destination_folder="data",verbose=False,
                    locations=["/data/selene/ucfajlg/newform0111_data/",\
                               "/data/selene/ucfajlg/newform0111_data/lai_data/",\
                               "/archive/rsu_raid_0/plewis/public_html/newform0111_data"][::-1],\
                    ...
                    urls=["http://www2.geog.ucl.ac.uk/~ucfajlg/newform0111_data/",\
                          "http://www2.geog.ucl.ac.uk/~plewis/newform0111_data/",\
                          "http://www2.geog.ucl.ac.uk/~plewis/newform0111_data/lai_files/"][::-1]):
